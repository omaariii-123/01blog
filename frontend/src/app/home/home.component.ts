        ...
        <mat-card class="nav-card">
          <mat-card-content>
            ...
            <nav class="side-nav">
              ...
              <a
                [routerLink]="['/block', authService.currentUser()]"
                routerLinkActive="active"
                class="nav-item"
              >
                <mat-icon>person</mat-icon> My Block
              </a>
              <a href="#" class="nav-item"> <mat-icon>bookmarks</mat-icon> Saved Posts </a>
              <a href="#" class="nav-item"> <mat-icon>settings</mat-icon> Settings </a>
            </nav>
          </mat-card-content>
        </mat-card>
      </aside>
        ...
        <mat-card class="create-post-card">
          ...
          <div class="image-preview" *ngIf="selectedFile()">
            ...
            <video
              [src]="imagePreview()"
              controls
              style="max-height: 250px; border-radius: 8px; width: 100%; background: #000;"
            ></video>
            } @else {
            <img
              [src]="imagePreview()"
            ...
            <button class="remove-btn" (click)="removeFile()" style="z-index: 10;">
          ...
          <div class="create-post-actions">
            ...
            <button
              ...
              color="primary"
              (click)="createPost()"
              [disabled]="!newPostContent() && !selectedFile()"
            >
              Post
            </button>
          </div>
...
export class HomeComponent implements OnInit {
  ...
  previewType = signal<'image' | 'video' | null>(null); // New signal to track file type
